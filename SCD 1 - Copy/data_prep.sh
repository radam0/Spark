...
SRC_TBL="nikhilvemula.t_care_ca_rel_typ1_main"
TRGT_TBL="nikhilvemula.t_care_ca_rel_typ1_prev"
TRGT_TBL_PATH="hdfs://nn01.itversity.com:8020/apps/hive/warehouse/nikhilvemula.db/t_care_ca_rel_typ1_prev"
