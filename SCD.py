...
cond = ['PRTN_ID','CUS_ID','FBSI_BASE_C','FBSI_BRCH_C','FBSI_FIRM_C','FID_ACC_ID','REL_TY_C','MULTI_CO_N']
...
for each_col in range(len(fog_df_3_col)):
	fog_df_4 = fog_df_4.withColumnRenamed(fog_df_3_col[each_col] , fog_df_3_col_rename[each_col])
...
for each_col in range(len(fog_df_3_col)):
	fog_df_5 = fog_df_5.withColumnRenamed(fog_df_3_col[each_col] , fog_df_3_col_rename[each_col])
